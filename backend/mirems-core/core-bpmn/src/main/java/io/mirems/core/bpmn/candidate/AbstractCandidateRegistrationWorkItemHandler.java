...
abstract class AbstractCandidateRegistrationWorkItemHandler implements KogitoWorkItemHandler {
    ...
    @Override
    public WorkItemTransition newTransition(String phaseId, String status, Map<String, Object> data, Policy... policies) {
        return null;
    }
